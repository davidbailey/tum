...
### Conventions used in this handbook (these are not perfect and should be updated)
* Links
  1. Linked words go to Wikipedia
  2. Links to acutal organizations or documents are directly below the name of the organization or document and indented  
  3. Other links are left as plain links w/ no title
* Internal references take the form of (See Other Section)
