...
- [Infrastructure](#infrastructure)
  ...
  - [Rail Transport / Railway Engineering](#rail-transport--railway-engineering)
  - [Waterways](#waterways)
  - [Aqueducts](#aqueducts)
  - [Air](#air)
  - [Pipeline](#pipeline)
...
- [Intelligent Transportation Systems (ITS)](#intelligent-transportation-systems-its)
  ...
  - [Telematics (Telecommunications and Informatics)](#telematics-telecommunications-and-informatics)
...
- [Public Transportation](#public-transportation)
  ...
  - [Infrastructure - Dedicated or Shared w/ Private Transport](#infrastructure---dedicated-or-shared-w-private-transport)
  - [Public Transportation Modes](#public-transportation-modes)
  - [Right-of-Way](#right-of-way)
  - [Vehicle Guidance](#vehicle-guidance)
  ...
  - [Lines](#lines)
  - [Networks](#networks)
  - [Integration (Transfers)](#integration-transfers)
  - [Fares](#fares)
...
- [Sustainable Transportation Systems](#sustainable-transportation-systems)
  ...
  - [Ecological / Environmental Sustainability](#ecological--environmental-sustainability)
  - [Users](#users)
  - [Buzzwords](#buzzwords)
...
* Pollutants
  ...
  --- | --- | --- | ---
  NOx | 4-stroke, diesel, aircraft | high combustion temperature causes bonding of nitrogen and oxygen | lung function, acid rain, ozone formation
  Carbon Monoxide (CO) | 4-stroke, 2-stroke | incomplete combustion | inhibits the ability of blood to carry oxygen
  Volatile Organic Compounds (VOC) / Hydrocarbons (HC) | 4-stroke, 2-stroke | fuel | health, ozone formation
  Particulate Matter (PM) including Soot| diesel, 2-stroke, aircraft | combustion, tires on street | lung function, heart function
  Ozone (O3) | --- | [VOC + O2 + Light => (O2H)] + [NO2 + O2 + Light] | health, plant life
  SO2 | diesel | naturally present in crude oil | lung function, acid rain
  Lead (Pb) | --- | leaded gasoline, battery plants | affects intellectual development of children
  Heavy Metals | --- | --- | ---
  NH3 | --- | --- | ---
  N2O | --- | --- | ---
  CO2 | --- | --- | ---
...
* Emissions Standards
  ...
  * EPA Federal Test Procedure (FTP-75)
    * SC03 Supplemental Federal Test Procedure (SFTP)
...
* Monitoring
  * [Current concentrations of air pollutants in Germany](http://www.umweltbundesamt.de/en/data/current-concentrations-of-air-pollutants-in-germany) [www.umweltbundesamt.de]
* Greenhouse Gases
  * [Radiative Forcing](https://en.wikipedia.org/wiki/Radiative_forcing)
...
* Microscopic
  ...
  * Public Transportation Simulation
    ...
    * Dwell Times
      * Pedestrian Simulation
      * Dwell Time = Clearance Time + Alighting Time + Boarding Time
